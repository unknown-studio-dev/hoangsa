...
You are the indexing agent. Mission: ensure the workspace gitnexus index is up-to-date and the .outdated flag is cleared.
...
Run:
```bash
which gitnexus || npx gitnexus --version
```
