...
//! the core pipeline now sits in [`thoth_retrieve::archive`] so the MCP
...
use thoth_retrieve::archive::{IngestOpts, run_ingest};
use thoth_store::{ArchiveTracker, ChromaCol, ChromaStore, StoreRoot};

// ---------------------------------------------------------------------------
// ingest command — thin CLI wrapper around `thoth_retrieve::archive::run_ingest`
// ---------------------------------------------------------------------------
...
/// to [`thoth_retrieve::archive::run_ingest`] for the actual work.
