...
//! for persistence, and [`hoangsa_memory_policy::rules::compile_lessons`] for the
...
//! [`hoangsa_memory_policy::promotion`] policy).

use std::path::Path;

use anyhow::{Context, Result, anyhow, bail};
use hoangsa_memory_core::memory::{Enforcement, Lesson};
use hoangsa_memory_policy::rules::{Rule, compile_lessons};
...
mod promote_demote {
    ...
    use hoangsa_memory_core::memory::{Lesson, MemoryKind, MemoryMeta};
