    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <p className="text-muted-foreground text-sm">
          Daemon <code>hoangsa-memory-mcp</code> phục vụ các yêu cầu memory_recall,
      ...
      <Card className="overflow-hidden">
        ...
        <CardContent className="grid grid-cols-2 gap-x-4 gap-y-5 pt-6 sm:grid-cols-4">
          ...
          >
            <span
              className={status.ok ? "text-foreground" : "text-amber-600"}
            >
      ...
      {!status.ok && (
        <Alert>
          ...
          <AlertDescription>
            Tab Memory hiện không đầy đủ tính năng. Tuy nhiên các tab Config /
            Rules / Addons vẫn hoạt động bình thường — chúng đọc/ghi trực tiếp
            file, không phụ thuộc daemon.
          </AlertDescription>
        </Alert>
      )}
      ...
      <p className="text-muted-foreground text-xs">
        Memory browser (recall, fact CRUD, lesson editor) thuộc phase 2/3 — chưa
        có trong MVP này.
      </p>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              đang chạy. Claude Code tự khởi động lại lần sau khi cần memory tool.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
