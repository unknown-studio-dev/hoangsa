...
use hoangsa_memory_core::memory::{Enforcement, LessonTrigger};
...
pub mod layer_merge {
    ...
    use std::io;
    use std::path::Path;
    use hoangsa_memory_core::memory::{Enforcement, Lesson, LessonTrigger};
    ...
    mod tests {
        ...
        use hoangsa_memory_core::memory::{MemoryKind, MemoryMeta};
